<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="rptforSchool.aspx.cs" Inherits="TransportManagement.rptforSchool" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/rptforSchool.js"></script> 
</asp:Content>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:RadioButtonList ID="rdoReportList" CssClass="form-control form-control-sm" runat="server" Width="600px" Visible="False">
                                                    <asp:ListItem Selected="True" Value="0">Report for School</asp:ListItem>
