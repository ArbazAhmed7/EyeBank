<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="rptOpticianReport.aspx.cs" Inherits="TransportManagement.rptOpticianReport" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/rptOpticianReport.js"></script>
</asp:Content>
                        ...
                        <div class="col-md-12">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <asp:RadioButtonList ID="rdoType" runat="server" RepeatDirection="Horizontal" Width="425px" AutoPostBack="True">
