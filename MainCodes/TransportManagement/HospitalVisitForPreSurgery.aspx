<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="HospitalVisitForPreSurgery.aspx.cs" Inherits="TransportManagement.HospitalVisitForPreSurgery" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/HospitalVisitForPreSurgery.js"></script>
                ...
                <div class="content">
                    <div class="container">         
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h5 class="m-t-0 header-title"><b>Hospital visit for Pre-Surgery</b></h5>
                                    <hr />                                                                     
                                            ...
                                            <div class="row">
                                                <div class="container">                                                
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="Surgeryrecommended"> Surgery recommended: </label>
                                                                <asp:RadioButton ID="rdoSurgeryrecommended" runat="server" Text ="Yes" GroupName="SurgeryRecommended" AutoPostBack="True" OnCheckedChanged="rdoSurgeryrecommended_CheckedChanged" />
                                                                <asp:RadioButton ID="rdoSurgerynotrecommended" runat="server" Text ="No" GroupName="SurgeryRecommended" AutoPostBack="True" OnCheckedChanged="rdoSurgerynotrecommended_CheckedChanged" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="Surgeryrecommended"> Suggested Eye: </label>
                                                                <asp:Checkbox ID="chkRight" runat="server" Text ="Right" GroupName="SuggestedEye" />
                                                                <asp:Checkbox ID="chkLeft" runat="server" Text ="Left" GroupName="SuggestedEye"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                       <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="txtOphtRemarks">Remarks of Ophthalmologist </label>
                                                                <asp:TextBox ID="txtOphthalmologistRemarks" runat="server" CssClass="form-control form-control-sm" MaxLength="120" TabIndex="222"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                    ...
                                    <asp:Panel ID="pnlSurgerySuggested" runat="server" GroupingText="">                
                                    ...
                                    <div runat="server" id="pnlFollowupVisitSurgery" class="panel panel-primary">
                                        <div class="panel-heading" runat="server" >Surgery Date</div>
                                        <div class="panel-body" runat="server">
                                            <div class="row">
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtSurgeryDate" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                                            </div>
                                                        </div>                                                                
                                                    </div>       
                                                </div>
                                    ...
                                    <asp:Panel ID="pnlSurgeryNotSuggested" runat="server" GroupingText="">                
                                            ...
                                            <div class="row">
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <asp:RadioButton ID="rdoNotRequired" runat="server" Text ="Not Required" AutoPostBack="True" GroupName="FollowupVisit" OnCheckedChanged="rdoNotRequired_CheckedChanged" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <asp:RadioButton ID="rdoFollowupVisit" runat="server" Text ="Followup Date" AutoPostBack="True" GroupName="FollowupVisit" OnCheckedChanged="rdoFollowupVisit_CheckedChanged" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="lblWilling">Parent willing for Surgery</label> 
                                                                <asp:RadioButton ID="rdoYes" runat="server" Text ="Yes" AutoPostBack="True" GroupName="willing" OnCheckedChanged="rdoYes_CheckedChanged" />
                                                                <asp:RadioButton ID="rdoNo" runat="server" Text ="No" AutoPostBack="True" GroupName="willing" OnCheckedChanged="rdoNo_CheckedChanged" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:TextBox ID="txtReason" runat="server" CssClass="form-control form-control-sm" MaxLength="120"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
	                                ...
	                                <div class="panel-heading" runat="server" >
                                        <caption>
                                            Capture or Upload picture</caption>
                                    </div>
	                                <div class="panel-body" runat="server">
                                        <div class="row">
                                            <div class="col-sm-3">
