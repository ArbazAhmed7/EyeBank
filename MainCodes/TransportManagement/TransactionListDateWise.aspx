<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TransactionListDateWise.aspx.cs" Inherits="TransportManagement.TransactionListDateWise" %>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="info" style="padding-left:5px;">
                        <asp:Label ID="Label1" Text="To Generate Report: Select Entry date from & to and select any 'Form / Report' from dropdown" runat="server"></asp:Label></p>                        
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card-box">
                                <h5 class="m-t-0 header-title">
                                    <b>Transaction List (Entry Date Wise)</b></h5>
