...
namespace TransportManagement
{
    ...
    public partial class tblOptometristMasterTeacherAuditTrail
    {
        public int tblOptometristMasterTeacher_Id { get; set; }
        public Nullable<int> OptometristTeacherId { get; set; }
