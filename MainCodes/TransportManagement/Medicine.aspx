<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="Medicine.aspx.cs" Inherits="TransportManagement.Medicine" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/Medicine.js"></script>
    ...
    <script type="text/javascript">
        ...
        function validateInput() {
            ...
            if ($("[id$=txtMedicineDescription]").val().trim() == "") {
                $("[id$=txtMedicineDescription]").attr("style", "border: red 1px solid;")
                valRes = false;
            }
            else {
                $("[id$=txtMedicineDescription]").removeAttr("style");
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="MedicineAutoId">
                                                Medicine Id </label>
                                                <div class="input-group input-group-sm mb-3">
                                                <asp:TextBox ID="txtMedicineID" runat="server" AutoComplete="off" CssClass="form-control border-end-0 border rounded-pill" MaxLength="4" Enabled="False"></asp:TextBox>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtMedicineDescription" runat="server" AutoComplete="off" CssClass="form-control form-control-sm" MaxLength="50">                                                
                                            </asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
        ...
        <asp:HiddenField ID="hfMedicineIDPKID" runat="server" OnValueChanged="hfMedicineIDPKID_ValueChanged" Value="0" />
