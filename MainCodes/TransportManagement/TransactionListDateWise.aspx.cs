...
{
    public partial class TransactionListDateWise : System.Web.UI.Page
    {
        secoffEntities dx = new secoffEntities();

        protected void Page_Load(object sender, EventArgs e)
        {
            //if (!Utilities.CanView(Utilities.GetLoginUserID(), "Audit Trail"))
            //{
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateInput())
                {
                    ...
                    {
                        var dtSchoolEnrollmentView = dx.sp_TransactionList_SchoolEnrollment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
                    ...
                    {
                        var dtStudentEnrollmentView = dx.sp_TransactionList_StudentEnrollment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
                    ...
                    {
                        var dtTeacherEnrollmentView = dx.sp_TransactionList_TeacherEnrollment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
                    ...
                    {
                        var dtAutoRefTest = dx.sp_TransactionList_AutoRefTest(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
                    ...
                    {
                        var dtOptometer = dx.sp_TransactionList_Otpometrist(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
                    ...
                    {
                        var dtTreatment = dx.sp_TransactionList_Treatment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
                    ...
                    {
                        var dtGlassDespense = dx.sp_TransactionList_GlassDespenseStudent(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList();
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateInput())
                {
                    ...
                    if (strForm == "School Enrollment")
                    {
                        DataTable dtSchoolEnrollmentView = dx.sp_TransactionList_SchoolEnrollment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();

                        PrintReport(dtSchoolEnrollmentView, "SchoolEnrollment");
                    }
                    else if (strForm == "Student Enrollment")
                    {
                        DataTable dtStudentEnrollmentView = dx.sp_TransactionList_StudentEnrollment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();
                    ...
                    {
                        DataTable dtTeacherEnrollmentView = dx.sp_TransactionList_TeacherEnrollment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();

                        PrintReport(dtTeacherEnrollmentView, "TeacherEnrollment");
                    }
                    else if (strForm == "Auto Refraction Inspection")
                    {
                        DataTable dtAutoRefTest = dx.sp_TransactionList_AutoRefTest(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();

                        PrintReport(dtAutoRefTest, "AutoRefractionInspection");
                    }
                    else if (strForm == "Optometrist Inspection")
                    {
                        DataTable dtOptometer = dx.sp_TransactionList_Otpometrist(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();

                        PrintReport(dtOptometer, "OptometristInspection");
                    }
                    else if (strForm == "Diagnosis / Treatment / Next Visit")
                    {
                        DataTable dtTreatment = dx.sp_TransactionList_Treatment(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();

                        PrintReport(dtTreatment, "Treatment");
                    }
                    else if (strForm == "Followup visit dispensing Glasses")
                    {
                        var dtGlassDespense = dx.sp_TransactionList_GlassDespenseStudent(strForm, dtFrom.ToString("yyyy-MM-dd"), dtTo.ToString("yyyy-MM-dd")).ToList().ToDataTable();
