...
//    alert("I am here...!");
//    $("[id$=rdoFollowupAfterSixMonths] input").on("click", function () {
//        let SelFollowupAfterSixMonths = $("[id$=rdoFollowupAfterSixMonths] input:checked").val();

//        if (SelFollowupAfterSixMonths == '0') {
...
//    //if ($("[id$=rdoFollowupAfterSixMonths]").is(":checked")) {
    ...
    $("[id$=txtStudentCode]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowupVisitAfterSixMonths.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'StudentCode_AfterSixMonths','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
    ...
    $("[id$=txtStudentName]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowupVisitAfterSixMonths.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'StudentName_AfterSixMonths','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
    ...
    $("[id$=txtSchoolCode]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowupVisitAfterSixMonths.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'SchoolCode_AfterSixMonths','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
    ...
    $("[id$=txtSchoolName]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowupVisitAfterSixMonths.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'SchoolName_AfterSixMonths','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
