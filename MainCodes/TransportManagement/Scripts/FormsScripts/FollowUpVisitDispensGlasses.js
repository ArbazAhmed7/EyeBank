function pageLoad() {
    ShowHideControls();
    rdoStudentSatisficaion_Click();
    rdoListStudentNotSatisfiedOpt_Click();
    rdoUnsatisfiedReason_Click();
...
function ShowHideControls() {
    ...
    let SelrdoStudentSatisficaion = $("[id$=rdoStudentSatisficaion] input:checked").val();

    let SelrdoListStudentNotSatisfiedOpt = $("[id$=rdoListStudentNotSatisfiedOpt] input:checked").val();

    let SelrdoRefractionReason = $("[id$=rdoRefractionReason] input:checked").val();

    if (SelrdoStudentSatisficaion == '0') {
        $("[id$=DIVrdoListStudentNotSatisfiedOpt]").show();
    }
    else {
        $("[id$=DIVrdoListStudentNotSatisfiedOpt]").hide();
    }


    if (SelrdoListStudentNotSatisfiedOpt == '3') {
        $("[id$=DIVtxtStudentNotSatisfiedOtherComment]").show();
    }
    else {
        $("[id$=DIVtxtStudentNotSatisfiedOtherComment]").hide();
    }

    if (SelrdoListStudentNotSatisfiedOpt == '0') {
        $("[id$=DIVrdoRefractionReason]").show();
    }
    else {
        $("[id$=DIVrdoRefractionReason]").hide();
    }
    
    if (SelrdoRefractionReason == '1') {
        $("[id$=DIVpnlSubjectiveRefraction]").show();
    }
    else {
        $("[id$=DIVpnlSubjectiveRefraction]").hide();
    }
...
function rdoStudentSatisficaion_Click() {
    $("[id$=rdoStudentSatisficaion] input").on("click", function () {
...
function rdoListStudentNotSatisfiedOpt_Click() {
    $("[id$=rdoListStudentNotSatisfiedOpt] input").on("click", function () {
        ShowHideControls();
    });
}


function rdoUnsatisfiedReason_Click() {
    $("[id$=rdoRefractionReason] input").on("click", function () {
        ShowHideControls();
    });
}
    ...
    $("[id$=txtStudentCode]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowUpVisitDispensGlasses.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'StudentCode_GlassDispense','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
    ...
    $("[id$=txtStudentName]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowUpVisitDispensGlasses.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'StudentName_GlassDispense','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
    ...
    $("[id$=txtSchoolCode]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowUpVisitDispensGlasses.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'SchoolCode_GlassDispense','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
    ...
    $("[id$=txtSchoolName]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowUpVisitDispensGlasses.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'SchoolName_GlassDispense','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
    ...
    $("[id$=txtTeacherCode]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowUpVisitDispensGlasses.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'TeacherCode_GlassDispense','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
    ...
    $("[id$=txtTeacherName]")
        ...
        .autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "FollowUpVisitDispensGlasses.aspx/AutoComplete",
                    data: "{'Term' :'" + request.term + "','TermType' :'TeacherName_GlassDispense','Id' :'0'}",
                    dataType: "json",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
