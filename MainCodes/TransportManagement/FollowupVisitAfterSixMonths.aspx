<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="FollowupVisitAfterSixMonths.aspx.cs" Inherits="TransportManagement.FollowupVisitAfterSixMonths" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/FollowupVisitAfterSixMonths.js"></script>
                ...
                <div class="content">
                    <div class="container">         
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h5 class="m-t-0 header-title"><b>Follow up visit after 6 months</b></h5>
                                    <hr />                                                                     
                                    <%--<div class="row">
                                        <div class="col-sm-6">
                                    ...
                                    <div runat="server" id="pnl_AutoRefTestRes" style="display:none;" class="panel panel-primary">
                                        ...
                                        <div class="panel-body" runat="server">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="lblutoRefPrevVisitDate">Previous visit date: </label>
                                                        <asp:Label ID="lblAutoRefPrevVisitDate" runat="server"  ></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">                                               
                                              <div class="col-xs-12 col-sm-6">
	                                            <table class="auto-style1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblSpherical_RightEye_AutoRef" runat="server" ></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblCylinderical_RightEye_AutoRef" runat="server" ></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblAxix_RightEye_AutoRef" runat="server" ></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                              </div>
                                              ...
                                              <div class="col-xs-12 col-sm-6">
	                                            <div id="pnlLeftEye_AutoRef" runat="server">
                                                    <table class="auto-style1">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblSpherical_LeftEye_AutoRef" runat="server" ></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblCylinderical_LeftEye_AutoRef" runat="server" ></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblAxix_LeftEye_AutoRef" runat="server" ></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
	                                            </div>
                                        ...
                                        <div class="panel-body" runat="server">
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
	                                            <table class="auto-style1">
                                                    <tr>
                                                        <td><asp:Label ID="Label14" runat="server"  Text="Right"></asp:Label></td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            &nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label15" runat="server" Text="Spherical"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label16" runat="server" Text="Cylinderical"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label17" runat="server" Text="Axix"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label18" runat="server" Text="Near Add"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                              ...
                                              <div class="col-xs-12 col-sm-6">
	                                            <div id="Div1" runat="server">
                                                    <table class="auto-style1">
                                                        <tr>
                                                            <td><asp:Label ID="Label19" runat="server"  Text="Left"></asp:Label></td>
                                                            <td>
                                                                &nbsp;</td>
                                                            <td>
                                                                &nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label20" runat="server" Text="Spherical"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label21" runat="server" Text="Cylinderical"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label22" runat="server" Text="Axix"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label23" runat="server" Text="Near Add"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                    ...
                                    <%-- style="line-height:3px" <div runat="server" id="Div5" class="panel panel-primary">
                                        <div class="panel-heading" runat="server" >Visit Summary (Previous Visit)</div>
                                        <div class="panel-body" runat="server">
                                            <div class="row">
                                                <div class="col-sm-6">--%>
                                    <table class="auto-style1">
                                                    ...
                                                    <table class="auto-style2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <asp:Label ID="lblTreat" runat="server" Text="Treatment"></asp:Label>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <asp:Label ID="lblTreatment" runat="server" Font-Bold="True" Font-Size="9pt"></asp:Label>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>&nbsp;</td>
                                    ...
                                    <div runat="server" id="Div4" class="panel panel-primary">
                                        <div class="panel-heading" runat="server" >Auto Refraction Test (Current Date)</div>
                                        <div class="panel-body" runat="server">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div runat="server" id="pnl_VisualAcuity" class="panel panel-primary">
                                    ...
                                    <div runat="server" id="pnl_SubjRef" class="panel panel-primary">
	                                    <div class="panel-heading" runat="server" >Subjective Refraction (Current Date)</div>
	                                    <div class="panel-body" runat="server">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:RadioButtonList ID="rdoDouchrome" runat="server" RepeatDirection="Horizontal" Width="425px" TabIndex="42">
                                    ...
                                    <div runat="server" id="pnl_ObjRef" class="panel panel-primary">
	                                    <div class="panel-heading" runat="server" >Objective Refraction</div>
	                                    <div class="panel-body" runat="server">
                                            <div class="row">
	                                            <div class="col-xs-12 col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group">
                                                                                <label for="RetinoScopy_RightEye"> Retinoscopy </label>
                                                                                    <asp:RadioButtonList ID="rdoRetinoScopy_RightEye" runat="server" RepeatDirection="Horizontal" Width="425px" AutoPostBack="True" TabIndex="45" OnSelectedIndexChanged="rdoRetinoScopy_RightEye_SelectedIndexChanged" >
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group">
                                                                                <label for="RetinoScopy_LeftEye"> Retinoscopy </label>
                                                                                    <asp:RadioButtonList ID="rdoRetinoScopy_LeftEye" runat="server" RepeatDirection="Horizontal" Width="425px" AutoPostBack="True" TabIndex="47" OnSelectedIndexChanged="rdoRetinoScopy_LeftEye_SelectedIndexChanged" >
                                                                                        <asp:ListItem Value="0" Selected="True">Normal Reflex</asp:ListItem>
                                                                                        <asp:ListItem Value="1">Dull Reflex</asp:ListItem>
                                                                                        <asp:ListItem Value="2">Scissor Reflex</asp:ListItem>                                                                            
                                                                                    </asp:RadioButtonList>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="form-group">
                                                            <table>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td><asp:Label ID="Label27" runat="server" Text="Right" Width="300px" Font-Bold="True" ></asp:Label></td>
                                                                    <td><asp:Label ID="Label39" runat="server" Text="Left" Width="200px" Font-Bold="True" ></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td><asp:Label ID="Label40" runat="server" Text="Other" Width="300px" ></asp:Label></td>
                                        ...
                                        <div class="panel-heading" runat="server" >Diagnosis</div>
                                            <div class="panel-body" runat="server">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                                <asp:RadioButtonList ID="chkListRefractiveErrorOpt" runat="server" RepeatDirection="Vertical" Width="425px" AutoPostBack="True" >
                                                                    <asp:ListItem Value="0">Presbyopia</asp:ListItem>
                                                                    <asp:ListItem Value="1">Myopia</asp:ListItem>
                                                                    <asp:ListItem Value="2">Hypermetropia</asp:ListItem>
                                                                    <asp:ListItem Value="3">Astigmatism</asp:ListItem>
	                                        ...
	                                        <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RadioButtonList ID="rdoTreatment_Glasses" runat="server" RepeatDirection="Vertical" Width="425px" TabIndex="52">
                                        ...
                                        <div class="panel-body" runat="server">
                                             <div class="row">                                                          
                                                <div class="col col-lg-3">                                                   
                                                    <asp:RadioButton  ID="rdoNotRequiredFollowup" GroupName="FollowupVisit" Text="Not required" Checked="false" runat="server" CssClass="form-control no-border" AutoPostBack="True" OnCheckedChanged="rdoNotRequiredFollowup_CheckedChanged" />
                                                </div>
                                             </div>
                                            <div class="row">                                                          
                                                <div class="col col-lg-3">                                                   
                                                    <asp:RadioButton  ID="rdoFollowupAfterSixMonths" GroupName="FollowupVisit" Text="After Six Months" Checked="false" runat="server" CssClass="form-control no-border" AutoPostBack="True" OnCheckedChanged="rdoFollowupAfterSixMonths_CheckedChanged" />
                                                </div>
                                             </div>
                                             <div class="row">  
                                                 <div class="col col-lg-3">
                                                    <asp:RadioButton  ID="rdoNextVisitDate" GroupName="FollowupVisit" Text="Next Visit Date" Checked="false" runat="server" CssClass="form-control no-border" AutoPostBack="True" OnCheckedChanged="rdoNextVisitDate_CheckedChanged" />                                                    
                                                </div>
                                                <div class="col col-lg-3">
                                                    <div class="form-group" id="divtxtRoutineCheckupDate" >
                                                        ...
                                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtRoutineCheckupDate" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div runat="server" id="pnlUploadPicture" class="panel panel-primary">
	                                    ...
	                                    <div class="panel-body" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <asp:FileUpload ID="btnBrowse" ClientIDMode="Static" runat="server" onchange="ShowPreview(this)" accept="image/*" multiple="false" CssClass="btn btn-default btn-sm" Width="105px" TabIndex="43" />
                                                        <asp:Label ID="lblFileUploadStudent" runat="server"></asp:Label>
                                                        &nbsp;<asp:Button ID="AddButton" runat="server"  Text="Load Image" CssClass="btn btn-default btn-sm" Visible="False" OnClick="AddButton_Click" TabIndex="44" />                                                
                                                    </div>
                                                </div>                                        
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                Capture Date </label>                                                
                                                <asp:TextBox ID="txtCaptureDate" runat="server" AutoComplete="off" CssClass="form-control form-control-sm" MaxLength="11" Width="125px" TabIndex="45"></asp:TextBox>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCaptureRemarks" runat="server" AutoComplete="off" CssClass="form-control form-control-sm" MaxLength="120" TabIndex="46" ></asp:TextBox>
