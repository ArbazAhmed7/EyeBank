<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="rptSixMonthVisit.aspx.cs" Inherits="TransportManagement.rptSixMonthVisit" %>
                        ...
                        <div class="col-md-12">
                            <div class="card-box">
                                <h5 class="m-t-0 header-title">
                                    <b>Report for Six Months Visit Multiple Students</b></h5>
                                <p class="text-muted font-13 m-b-30">
                                   ...
                                   <%-- <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:RadioButtonList ID="rdoReportType" runat="server" AutoPostBack="True" Width="300px">
                                                    <asp:ListItem Selected="True" Value="0">Visit Date falling between </asp:ListItem>
                                                    <asp:ListItem Value="1">Next Visit Date falling between </asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
                                    </div> 
