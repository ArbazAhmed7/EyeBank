...
{
    public partial class LookupControlMultiColumn : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            dtFinalResult.Columns.AddRange(new DataColumn[4] {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                try
                {
                    if (Session["Code"] != null)
                    {
                        ...
                        e.Row.Cells[3].Text = Session["Description"].ToString();
                    }
                    else
                    {
