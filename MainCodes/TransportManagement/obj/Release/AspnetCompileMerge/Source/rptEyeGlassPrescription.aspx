<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="rptEyeGlassPrescription.aspx.cs" Inherits="TransportManagement.rptEyeGlassPrescription" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/rptEyeGlassPrescription.js"></script>  
</asp:Content>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                <h5 class="m-t-0 header-title"><b>Eye Glass Prescripion</b></h5>                                
                                <hr />
                                <div class="row">
                                    <div class="col-sm-3">
	                                ...
	                                <div class="panel-body" runat="server">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <asp:RadioButtonList ID="rdoStudentSelectionType" runat="server" OnSelectedIndexChanged="rdoStudentSelectionType_SelectedIndexChanged" RepeatDirection="Horizontal" Width="425px" AutoPostBack="True">
                                                                    <asp:ListItem Selected="True" Value="0">Single Student</asp:ListItem>
                                                                    <asp:ListItem Value="1">Multiple Student</asp:ListItem>
                                                                </asp:RadioButtonList>
                                                    </div>
                                                </div>
	                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="StudentName">Student Code (Bulk)</label>
                                                            <asp:TextBox ID="txtStudentCode_Bulk" runat="server" AutoComplete="off" CssClass="form-control form-control-sm" TextMode="MultiLine" ToolTip="Enter Student Codes with Comma Separated Values."></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
	                            ...
	                            <div class="panel-body" runat="server">
		                            <div class="row">		
			                            <div class="col-xs-12 col-sm-6">
                                            <div class="col-sm-3">
                                                <asp:RadioButtonList ID="rdoTeacherSelectionType" runat="server" OnSelectedIndexChanged="rdoTeacherSelectionType_SelectedIndexChanged" RepeatDirection="Horizontal" Width="425px" AutoPostBack="True">
                                                            <asp:ListItem Selected="True" Value="0">Single Teacher</asp:ListItem>
                                                            <asp:ListItem Value="1">Multiple Teacher</asp:ListItem>
                                                        </asp:RadioButtonList>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="TeacherName">Teacher Code (Bulk)</label>
                                                            <asp:TextBox ID="txtTeacherCode_Bulk" runat="server" AutoComplete="off" CssClass="form-control form-control-sm" TextMode="MultiLine" ToolTip="Enter Teacher Codes with Comma Separated Values."></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
			                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <asp:RadioButtonList ID="rdoReportType" runat="server" RepeatDirection="Horizontal" Width="425px">
                                                <asp:ListItem Selected="True" Value="0">Complete Card</asp:ListItem>
                                                <asp:ListItem Value="1">Pre-printed Card</asp:ListItem>
                                            </asp:RadioButtonList>
                                </div>
                            </div>
