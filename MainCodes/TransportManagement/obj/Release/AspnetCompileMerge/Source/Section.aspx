<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="Section.aspx.cs" Inherits="TransportManagement.Section" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/FormsScripts/Section.js"></script>
    ...
    <script type="text/javascript">
        ...
        function validateInput() {
            ...
            if ($("[id$=txtClassSection]").val().trim() == "") {
                $("[id$=txtClassSection]").attr("style", "border: red 1px solid;")
                valRes = false;
            }
            else {
                $("[id$=txtClassSection]").removeAttr("style");
            }
                        ...
                        <div class="col-md-12">
                            <div class="card-box">
                                <h5 class="m-t-0 header-title">
                                    <b>Addition of Class Section</b></h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtSectionCode" runat="server" AutoComplete="off" CssClass="form-control border-end-0 border rounded-pill" MaxLength="4" Enabled="False"></asp:TextBox>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                Section * </label>
                                                <asp:TextBox ID="txtClassSection" runat="server" AutoComplete="off" CssClass="form-control form-control-sm" MaxLength="2">                                                
                                            </asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
