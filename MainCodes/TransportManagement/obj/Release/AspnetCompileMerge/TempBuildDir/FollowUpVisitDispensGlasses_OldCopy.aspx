<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FollowUpVisitDispensGlasses_OldCopy.aspx.cs" Inherits="TransportManagement.FollowUpVisitDispensGlasses_OldCopy" %>
                                    ...
                                    <%--<div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="TransDate">
                                                Date *</label>                                                
                                                <asp:Label ID="lblTestDate" runat="server" Font-Bold="True"></asp:Label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div runat="server" id="pnlStudent_Sub" class="col-xs-12 col-sm-6">
                                                    <table class="auto-style2">
                                                        <tr>
                                                            <td><asp:Label ID="Label7" class="small text-muted pr-2" runat="server" Text="Father Name" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblFatherName_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="Label8" class="small text-muted pr-2" runat="server" Text="Age" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblAge_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="Label9" class="small text-muted pr-2" runat="server" Text="Gender" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblGender_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="Label10" class="small text-muted pr-2" runat="server" Text="Class" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblClass_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="Label11" class="small text-muted pr-2" runat="server" Text="School" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblSchoolName_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="Label12" class="small text-muted pr-2" runat="server" Text="Wearing glasses" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblWearingGlasses_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="Label13" class="small text-muted pr-2" runat="server" Text="Decreased Vision" Font-Bold="True"></asp:Label></td>
                                                            <td><asp:Label ID="lblDecreasedVision_Student" runat="server" Font-Bold="True"></asp:Label></td>
                                                        </tr>
                                                    </table>                                                  
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-6">
	                                            <table class="auto-style1">
                                                    <tr>
                                                        <td><asp:Label ID="Label28" runat="server" Font-Bold="true" Text="Right"></asp:Label></td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            &nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblSpherical_RightEye" runat="server" Font-Bold="True"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblCylinderical_RightEye" runat="server" Font-Bold="True"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblAxix_RightEye" runat="server" Font-Bold="True"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblNearAdd_RightEye" runat="server" Font-Bold="True"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                              </div>
                                              ...
                                              <div class="col-xs-12 col-sm-6">
	                                            <div id="pnlLeftEye_AutoRef" runat="server">
                                                    <table class="auto-style1">
                                                        <tr>
                                                            <td><asp:Label ID="Label29" runat="server" Font-Bold="true" Text="Left"></asp:Label></td>
                                                            <td>
                                                                &nbsp;</td>
                                                            <td>
                                                                &nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblSpherical_LeftEye" runat="server" Font-Bold="True"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblCylinderical_LeftEye" runat="server" Font-Bold="True"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblAxix_LeftEye" runat="server" Font-Bold="True"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblNearAdd_LeftEye" runat="server" Font-Bold="True"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
	                                            </div>
