<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LookupControl.aspx.cs" EnableEventValidation = "false" Inherits="TransportManagement.LookupControl.LookupControl" %>
            ...
            <ContentTemplate>
                ...
                <div>    
                 <asp:GridView ID="gvitems" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" 
                     Width="399px" EnableModelValidation="True" OnSelectedIndexChanging="gvitems_SelectedIndexChanging"  CssClass="table table-striped table-bordered m-b-0"
