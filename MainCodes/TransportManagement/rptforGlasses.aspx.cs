...
{
    public partial class rptforGlasses : System.Web.UI.Page
    {
        secoffEntities dx = new secoffEntities();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Utilities.CanView(Utilities.GetLoginUserID(), "rptforGlasses"))
            {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateInput())
                {
                    ...
                    {
                        string jsReport = "<script type='text/javascript'>var newHeight = screen.height - 80;window.open('ReportViewerRDLC.aspx?vReportName=rptDetailGlassesProvided&FromDate=" + strFromDate + "&ToDate=" + strToDate + "&SchoolAutoId=" + hfSchoolIDPKID.Value + "&ReportType=" + rdoReportType.SelectedValue + "','','height='+newHeight+',width=1600,menubar=no,status=yes,location=no,top=1,left=1,scrollbars=yes,resizable=yes')</script>";
                        ClientScript.RegisterStartupScript(this.GetType(), "popup", jsReport, false);
                    }
                    else if (rdo5.Checked == true)
                    {
                        string jsReport = "<script type='text/javascript'>var newHeight = screen.height - 80;window.open('ReportViewerRDLC.aspx?vReportName=rptRefractedErrorGlassesnotProvidedDetail&FromDate=" + strFromDate + "&ToDate=" + strToDate + "&SchoolAutoId=" + hfSchoolIDPKID.Value + "&ReportType=" + rdoReportType.SelectedValue + "','','height='+newHeight+',width=1600,menubar=no,status=yes,location=no,top=1,left=1,scrollbars=yes,resizable=yes')</script>";
                        ClientScript.RegisterStartupScript(this.GetType(), "popup", jsReport, false);
                    }
                    else if (rdo7.Checked == true)
                    {
                        string jsReport = "<script type='text/javascript'>var newHeight = screen.height - 80;window.open('ReportViewerRDLC.aspx?vReportName=rptDetailGlassesProvidedNotProvided&FromDate=" + strFromDate + "&ToDate=" + strToDate + "&SchoolAutoId=" + hfSchoolIDPKID.Value + "&ReportType=" + rdoReportType.SelectedValue + "','','height='+newHeight+',width=1600,menubar=no,status=yes,location=no,top=1,left=1,scrollbars=yes,resizable=yes')</script>";
                        ClientScript.RegisterStartupScript(this.GetType(), "popup", jsReport, false);
                    }
                    ...
                    if (dtSchool != null)
                    {
                        if (dtSchool.Rows.Count > 0)
                        {
                            ...
                            using (ExcelPackage excel = new ExcelPackage())
                            {
                                ...
                                workSheet = excel.Workbook.Worksheets.Add("GlassesProvided");
                                ...
                                Utilities.SetTimeStamp(workSheet, "Refracted Errors Report");
                                ...
                                if (dtMainReport_FilteredTable.Rows.Count > 0)
                                {
                                    ...
                                    workSheet.Cells[FirstRow, 10].Value = "Glass Despensing Date";
                                ...
                                Response.AddHeader("content-disposition", "attachment;  filename=GlassesProvided.xlsx");
                    ...
                    if (dtSchool != null)
                    {
                        if (dtSchool.Rows.Count > 0)
                        {
                            ...
                            using (ExcelPackage excel = new ExcelPackage())
                            {
                                ...
                                workSheet = excel.Workbook.Worksheets.Add("GlassesnotProvided");
                                ...
                                if (dtMainReport_FilteredTable.Rows.Count > 0)
                                {
                                    ...
                                    workSheet.Cells[FirstRow, 7].Value = "Father Name";
                                    workSheet.Cells[FirstRow, 8].Value = "Gender";
                                    workSheet.Cells[FirstRow, 9].Value = "Spherical (Right Eye)";
                                    workSheet.Cells[FirstRow, 10].Value = "Cyclinderical (Right Eye)";
                                    workSheet.Cells[FirstRow, 11].Value = "Axix (Right Eye)";
                                    workSheet.Cells[FirstRow, 12].Value = "NearAdd (Right Eye)";
                                    ...
                                    workSheet.Cells[FirstRow, 16].Value = "NearAdd (Left Eye)";
                                    ...
                                    foreach (DataRow dr in dtMainReport_FilteredTable.Rows)
                                    {
                                        ...
                                        {
                                            //workSheet.Cells[FirstRow, FirstColumn, FirstRow, FirstColumn].Value = dr[dc].ToString();
                                            if (FirstColumn == 1 || FirstColumn == 2 || FirstColumn == 3 || FirstColumn == 4 || FirstColumn == 5 || FirstColumn == 6 || FirstColumn == 7 || FirstColumn == 8)
                                            {
                                                workSheet.Cells[FirstRow, FirstColumn, FirstRow, FirstColumn].Value = dr[dc].ToString();
                                                workSheet.Cells[FirstRow, FirstColumn, FirstRow, FirstColumn].Style.HorizontalAlignment = OfficeOpenXml.Style.ExcelHorizontalAlignment.Left;
                                            }
                                            else if (FirstColumn == 11 || FirstColumn == 15)
                                            {
                                                try
                                                {
                                ...
                                Response.Clear();
                                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                                Response.AddHeader("content-disposition", "attachment;  filename=GlassesnotProvided.xlsx");
                                Response.BinaryWrite(excel.GetAsByteArray());
                                Response.Flush();
                                Response.End();
                            }
