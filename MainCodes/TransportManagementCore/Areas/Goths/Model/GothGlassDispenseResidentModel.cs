...
{
    public class GothGlassDispenseResidentModel : OptometristGothResidentModel
    {
    ...
    public class DisplayGothGlassDispenseResidentModel : DisplayAutoRefResidentModel
    {
        public int OptometristGothResidentId { get; set; }
        public bool Distance { get; set; }
        public bool Near { get; set; }
