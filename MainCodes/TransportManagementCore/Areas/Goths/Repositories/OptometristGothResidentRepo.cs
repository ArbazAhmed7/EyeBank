...
{
    public class OptometristGothResidentRepo
    {
        DBHelper.DBHelper db;
        public OptometristGothResidentRepo()
        {
        ...
        public List<SqlParameter> SetModel(List<SqlParameter> para, OptometristGothResidentModel model)
        {
            para.Add(new("OptometristGothResidentId", model.OptometristGothResidentId));
            para.Add(new("OptometristGothResidentTransDate", model.OptometristGothResidentTransDate));
        ...
        public OptometristGothResidentModel GetOptometristResidentLast(DataTable dt)
        {
            OptometristGothResidentModel auto = null;
            if (dt.Rows.Count > 0)
            {
                auto = new OptometristGothResidentModel();
                auto.OptometristGothResidentId = Convert.ToInt32(dt.Rows[0]["OptometristGothResidentId"]);
                auto.OptometristGothResidentTransDate = Convert.ToDateTime(dt.Rows[0]["OptometristGothResidentTransDate"]);
                auto.ResidentAutoId = Convert.ToInt32(dt.Rows[0]["ResidentAutoId"]);
                auto.GothAutoId = Convert.ToInt32(dt.Rows[0]["GothAutoId"]);
