...
{
    public class GothAutoRefTestResidentRepo
    {
             DBHelper.DBHelper db;
            public GothAutoRefTestResidentRepo()
            {
            ...
            public List<SqlParameter> SetModel(List<SqlParameter> para, GothAutoRefTestResidentModel model)
            {
            ...
            public List<GothAutoRefTestResidentModel> GetAutoRefTestModel(DataTable dt)
            {
                List<GothAutoRefTestResidentModel> list = new List<GothAutoRefTestResidentModel>();
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        GothAutoRefTestResidentModel at = new GothAutoRefTestResidentModel();
            ...
            public GothAutoRefTestResidentModel AutoRefModel(DataTable dt)
            {
