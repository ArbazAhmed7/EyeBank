...
{
    public class PublicSpacesResidentEnrollmentRepo
    {
        DBHelper.DBHelper db;
        public PublicSpacesResidentEnrollmentRepo()
        {
        ...
        public List<SqlParameter> SetModelImage(List<SqlParameter> para, PublicSpacesResidentEnrollmentImageModel cm, int ResidentId, int PublicSpacesId)
        {

            if (cm.FileName != "" && cm.FileName != null)
            {
                //cm.PublicSpacesPic = Convert.FromBase64String(cm.PublicSpacesPicture);
                para.Add(new("@ResidentImageAutoId", cm.ResidentImageAutoId));
                para.Add(new("@ResidentAutoId", ResidentId));
                para.Add(new("@PublicSpacesAutoId", PublicSpacesId));
        ...
        public List<SqlParameter> SetModel(List<SqlParameter> para, PublicSpacesResidentEnrollmentModel model)
        {
