...
namespace TransportManagementCore.Areas.PublicSpacess.Repositories
{
    public class OptometristPublicSpacesResidentRepo
    {
        DBHelper.DBHelper db;
        public OptometristPublicSpacesResidentRepo()
        {
        ...
        public List<SqlParameter> SetModel(List<SqlParameter> para, OptometristPublicSpacesResidentModel model)
        {
            para.Add(new("OptometristPublicSpacesResidentId", model.OptometristPublicSpacesResidentId));
            para.Add(new("OptometristResidentTransDate", model.OptometristResidentTransDate));
        ...
        public OptometristPublicSpacesResidentModel GetOptometristResidentLast(DataTable dt)
        {
            OptometristPublicSpacesResidentModel auto = null;
            if (dt.Rows.Count > 0)
            {
                auto = new OptometristPublicSpacesResidentModel();
                auto.OptometristPublicSpacesResidentId = Convert.ToInt32(dt.Rows[0]["OptometristPublicSpacesResidentId"]);
                auto.OptometristResidentTransDate = Convert.ToDateTime(dt.Rows[0]["OptometristResidentTransDate"]);
                auto.ResidentAutoId = Convert.ToInt32(dt.Rows[0]["ResidentAutoId"]);
                auto.PublicSpacesAutoId = Convert.ToInt32(dt.Rows[0]["PublicSpacesAutoId"]);
                ...
                auto.AutoRefResidentId = Convert.ToInt32(dt.Rows[0]["AutoRefResidentId"]);
