...
{
    public class PublicSpacesAutoRefTestResidentRepo
    {
        DBHelper.DBHelper db;
        public PublicSpacesAutoRefTestResidentRepo()
        {
        ...
        public PublicSpacesResidentEnrollmentModel GetModel(DataTable dt)
        {
            PublicSpacesResidentEnrollmentModel CM = new PublicSpacesResidentEnrollmentModel();
            List<PublicSpacesResidentEnrollmentImageModel> ListModel = new List<PublicSpacesResidentEnrollmentImageModel>();
            foreach (DataRow row in dt.Rows)
            {
                PublicSpacesResidentEnrollmentImageModel DetailModel = new PublicSpacesResidentEnrollmentImageModel();
                ...
                if (!row["DetailPublicSpacesAutoId"].Equals(DBNull.Value))
                    DetailModel.DetailPublicSpacesAutoId = Convert.ToInt32(row["DetailPublicSpacesAutoId"]);
        ...
        public List<SqlParameter> SetModel(List<SqlParameter> para, PublicSpacesAutoRefTestResidentModel model)
        {
        ...
        public List<PublicSpacesAutoRefTestResidentModel> GetAutoRefTestModel(DataTable dt)
        {
            List<PublicSpacesAutoRefTestResidentModel> list = new List<PublicSpacesAutoRefTestResidentModel>();
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow row in dt.Rows)
                {
                    PublicSpacesAutoRefTestResidentModel at = new PublicSpacesAutoRefTestResidentModel();
        ...
        public PublicSpacesAutoRefTestResidentModel AutoRefModel(DataTable dt)
        {
