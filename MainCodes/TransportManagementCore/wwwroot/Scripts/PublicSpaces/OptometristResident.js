...
$('#chkNew').on('change', function () {
    if ($('#chkNew').is(':checked')) {
        ...
        $('#txtPublicSpacesOptometristResidentId').val('')
...
function GetModal(Id) {
    $.ajax({
        url: '/PublicSpaces/PublicSpacesAutoRefTestResident/GetAutoRefByResidentId/' + Id,
        method: 'get',
        dataType: 'json',
...
function GetDates() {
    if (($('#chkDisplay').is(':checked')) || $('#chkEdit').is(':checked')) {
        $.ajax({
            url: '/PublicSpaces/OptometristResident/GetDatesofResident/' + $('#txtResidentAutoId').val(),
            method: 'get',
            type: 'json',
            success: function (result) {
                console.log(result);
                $('#ddlGetPublicSpacesOptometristResidentById').empty();
                $("#ddlGetPublicSpacesOptometristResidentById").append($("<option></option>").val('').html(' Date'));
                $('#txtPublicSpacesOptometristResidentId').val('');
                $.each(result, function (data, value) {
                    $("#ddlGetPublicSpacesOptometristResidentById").append($("<option></option>").val(value.code).html(value.text));
                })
                $('#divDisplay').show();
                $('#ddlGetPublicSpacesOptometristResidentById').show()
                $('#ddlGetPublicSpacesOptometristResidentById').focus();
            }
        })
        setTimeout(function () {
            var total_tems = $('#ddlGetPublicSpacesOptometristResidentById').find('option').length;
            if (total_tems == 2) {
                $('#ddlGetPublicSpacesOptometristResidentById option:nth-child(2)').attr('selected', true);
                $('#ddlGetPublicSpacesOptometristResidentById').change()
            }
        ...
        $('#divDisplay').hide();
        $('#ddlGetPublicSpacesOptometristResidentById').hide()
    }
    if ($('#chkDisplay').is(':checked')) {
        $('#btnSave').hide();
    }
...
$('#ddlGetPublicSpacesOptometristResidentById').change(function () {
    $('#txtPublicSpacesOptometristResidentId').val($('#ddlGetPublicSpacesOptometristResidentById').val());
    if ($('#txtPublicSpacesOptometristResidentId').val() > 0) {
        $.ajax({
            url: '/PublicSpaces/OptometristResident/GetOptometristResidentById/' + $('#txtPublicSpacesOptometristResidentId').val(),
            method: 'get',
            dataType: 'json',
            success: function (result) {
                //ResetFields();
...
function SetModel(SetValues) {
    ...
    Clear();
    $('#txtPublicSpacesOptometristResidentId').val(SetValues.optometristPublicSpacesResidentId);
...
function GetAutoCompleteComapny() {
    ...
    $.ajax({
        //url: '/DropDownLookUp/Help/GetPublicSpacesForPublicSpacesOptometristResident/' + Type+'/'+$("#autocomplete-input-PublicSpaces").val(),
        url: '/DropDownLookUp/Help/GetPublicSpacesForOptometristResident',
...
function GetAutoCompleteResident() {
    ...
    if ($('#txtPublicSpacesId').val() > 0) {
        $.ajax({
            //url: '/DropDownLookUp/Help/GetResidentsForOptometrist/' + $('#txtPublicSpacesId').val() + "/" + Type + "/" + FinalDate,
            url: '/DropDownLookUp/Help/GetPublicSpacesResidentsForOptometrist',
            data: GeResidentText(),
            method: 'get',
            dataType: 'json',
            success: function (result) {
...
$('#btnSave').click(function () {
    ...
    if ($('#txtPublicSpacesOptometristResidentId').val() || 0 > 0) {
        Title = 'Update';
    }
    $.confirm({
        title: Title,
        ...
        buttons: {
            confirm: function () {
                $.ajax({
                    url: '/PublicSpaces/OptometristResident/SaveUpdate',
                    data: data,
                    method: 'post',
                    dataType: 'json',
                    success: function (result) {
...
function GetResidentInfo(Id) {
    $.ajax({
        url: '/PublicSpaces/PublicSpacesResidentEnrollment/GetById/' + Id,
        method: 'get',
        dataType: 'json',
        success: function (result) {
            //console.log(result);
...
$('#btnDelete').click(function () {
    if ($('#ddlGetPublicSpacesOptometristResidentById').val() != '' && $('#ddlGetPublicSpacesOptometristResidentById').val() != 'select') {
        $.confirm({
            title: 'Delete',
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        url: '/PublicSpaces/OptometristResident/DeleteById/' + $('#ddlGetPublicSpacesOptometristResidentById').val(),
                        method: 'post',
                        dataType: 'json',
                        success: function (result) {
                            //console.log(result);
