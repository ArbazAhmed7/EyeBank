var populateDtt = '/Localities/AutoRefTestResident/GetHistoryById/' + $('#txtResidentAutoId').val() + '; Auto Refraction Test History';
...
function GetModal() {
    $.ajax({
        url: '/Localities/GlassDispenseResident/GetLastOptoById',
        method: 'get',
...
function GetAutoCompleteLocality() {
    ...
    Localities = [];
    $.ajax({
        url: '/DropDownLookUp/Help/GetLocalitiesForGlassDispense',
...
function GetAutoCompleteResident() {
    ...
    if ($('#txtLocalityAutoId').val() > 0) {
        $.ajax({
            url: '/DropDownLookUp/Help/GetResidentsForGlassDispense',
            data: GeResidentText(),
            method: 'get',
            dataType: 'json',
            success: function (result) {
...
function GetDates() {
    if (($('#chkDisplay').is(':checked')) || $('#chkEdit').is(':checked')) {
        $.ajax({
            url: '/Localities/GlassDispenseResident/GetDatesofGlassDispenseResident/' + $('#txtResidentAutoId').val(),
            method: 'get',
            type: 'json',
            async: false,
            success: function (result) {
...
$('#ddlGetGlassDispenseId').change(function () {
    ...
    if ($('#ddlGetGlassDispenseId').val() > 0 && $('#txtResidentAutoId').val()>'0') {
        $.ajax({
            url: '/Localities/GlassDispenseResident/GetGlassDispenseById/' + $('#txtGlassDispenseResidentId').val(),
            method: 'get',
            dataType: 'json',
            success: function (result) {
                ResetFields();
...
$('#btnSave').click(function () {
    ...
    $.confirm({
        ...
        buttons: {
            confirm: function () {
                $.ajax({
                    url: '/Localities/GlassDispenseResident/SaveUpdate',
                    data: Model,
                    method: 'post',
                    dataType: 'json',
                    success: function (result) {
    ...
    if ($('#txtGlassDispenseResidentId').val() != '' && $('#txtGlassDispenseResidentId').val() != '0') {
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        url: '/Localities/GlassDispenseResident/DeleteById/' + $('#txtGlassDispenseResidentId').val(),
                        method: 'post',
                        dataType: 'json',
                        success: function (result) {
                            //console.log(result);
