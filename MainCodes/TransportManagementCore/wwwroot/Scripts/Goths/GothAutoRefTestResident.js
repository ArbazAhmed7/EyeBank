var populateDtt = '/Goths/GothAutoRefTestResident/GetHistoryById/' + $('#txtResidentAutoId').val() + '; Auto Refraction Test History';
...
function GetModal(Id) { 
    $.ajax({
        url: '/Goths/GothAutoRefTestResident/GetById/' + Id,
        method: 'get',
        dataType: 'json',
...
$('#btnSave').click(function () {
    ...
    $.confirm({
        ...
        buttons: {
            confirm: function () {
                $.ajax({
                    url: '/Goths/GothAutoRefTestResident/SaveUpdate',
                    data: Model,
                    method: 'post',
                    dataType: 'json',
                    success: function (result) {
...
$('#btnBack').click(function () {
    window.location = "/Goths/GothAutoRefTestResident/list";
})
...
function GetAutoCompleteGoth() {
    ...
    Goth = [];
    $.ajax({
        url: '/DropDownLookUp/Help/GetGothsForAutoRef',
        data: GetGothText(),
        method: 'get',
        dataType: 'json',
        success: function (result) {
...
function GetAutoCompleteResident() {
    ...
    if ($('#txtGothId').val() > 0) {
        Residents=[]
        $.ajax({
            // url: '/DropDownLookUp/Help/GetResidents/' + $('#txtGothId').val() + "/" + Type + "/" + FinalDate,
            url: '/DropDownLookUp/Help/GetGothResidentForAutoRef',
            data: GeResidentText(),
            method: 'get',
            dataType: 'json',
            success: function (result) {
...
function GetDates() {
    if (($('#chkDisplay').is(':checked')) || $('#chkEdit').is(':checked')) {
        $.ajax({
            url: '/Goths/GothAutoRefTestResident/GetDatesofResident/' + $('#txtResidentAutoId').val(),
            method: 'get',
            type: 'json',
            async: false,
            success: function (result) {
...
$('#ddlGetAutoRefId').change(function () {
    ...
    if ($('#txtAutoRefResidentId').val() > 0) {
        $.ajax({
            url: '/Goths/GothAutoRefTestResident/GetAutoRefById/' + $('#txtAutoRefResidentId').val(),
            method: 'get',
            dataType: 'json',
            success: function (result) {
                ResetFields();
    ...
    if ($('#ddlGetAutoRefId').val() != '' && $('#ddlGetAutoRefId').val() != 'select') {
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        url: '/Goths/GothAutoRefTestResident/DeleteById/' + $('#ddlGetAutoRefId').val(),
                        method: 'post',
                        dataType: 'json',
                        success: function (result) {
                            ////console.log(result);
